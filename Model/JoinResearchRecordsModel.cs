...
namespace Model
{
   public class JoinResearchRecordsModel
    {
        ...
        private string _researchmanager;
        private string _joinrole;
        ...
        /// 
        /// </summary>
        public string ResearchManager
        {
            set { _researchmanager = value; }
