<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="teachers_QuestionnaireInformation_List" %>
...
<head runat="server">
  ...
  <%--  <script type="text/javascript">
        $(function () {
            //$.post("List.aspx", function (data,status) {
            //    if (status == "success") {
            //        var json = eval("(" + data + ")");
                    
            //        var chart = new FusionCharts("../../FusionCharts/ScrollColumn2D.swf", "myChart", "1000", "500");
            //        chart.setJSONData(json);
            //        chart.render("FusionChart");
            //    } else {
            //        alert("服务器繁忙，请联系管理员");
            //    }
    ...
    <script type="text/javascript">
        ...
        $(function () {
            if (jsonData != "") {
                    ...
                    var chart = new FusionCharts("../../FusionCharts/ScrollColumn2D.swf", "myChart", "90%", "500");
    ...
    <script type="text/javascript">
        var TrainingBaseCode = "<%=training_base_code%>";
        var ProfessionalBaseCode = "<%=professional_base_code%>";
        var DeptCode = "<%=dept_code%>";
        var RealName = "<%=instructor%>";
        $(window).load(function () { 
            loadPageList(1);
        });

        function loadPageList(pi){
            $.post("ashx/List.ashx", { "pageIndex": pi, "TrainingBaseCode": TrainingBaseCode, "ProfessionalBaseCode": ProfessionalBaseCode, "DeptCode": DeptCode, "RealName": RealName },
              function (data) {
...
<body>
    <form id="form1" runat="server">
        <div>
            <div align="center">
                <br />
                <span class="style1">表1 满意度调查反馈表</span><br />
                <br />
            </div>
            ...
            <div align="center" id="FusionChart">
            </div>
               
            <div align="center">
                <span class="style1">图1 满意度调查反馈图</span>
                <br /><br /><br />
            </div>
        </div>
