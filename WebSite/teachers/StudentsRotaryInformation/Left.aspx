<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="teachers_StudentsRotaryInformation_Left" %>
    ...
    <div>
        <table cellpadding="1" cellspacing="1" class="qryTable">
           <tr>
            ...
            <tr>
                <td>出科状态：<asp:DropDownList ID="outdept_status" runat="server">
                        <asp:ListItem Value="" Text="==请选择==" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="0" Text="未出科" ></asp:ListItem>
                        <asp:ListItem Value="1" Text="已出科"></asp:ListItem>
                    <asp:ListItem Value="2" Text="顺延一期"></asp:ListItem>
                    </asp:DropDownList> </td>
            </tr>
            <tr>
                <td>
                    <div style="text-align:center;">     
                        <asp:Button ID="Button1" runat="server" Text="查询" CssClass="button" PostBackUrl="~/teachers/StudentsRotaryInformation/List.aspx" Height="25px" Width="50px" />
