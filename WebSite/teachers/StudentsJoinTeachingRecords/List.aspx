<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="teachers_StudentsJoinTeachingRecords_List" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        var TeachingObject = "<%=TeachingObject%>";
        var HeadTeacher = "<%=HeadTeacher%>";
        var TeachingDate = "<%=TeachingDate%>";
        $(function () {
        ...
        function loadPageList(pi) {
            $.post("../../ASHX/CommonList/JoinTeachingRecordsList.ashx", {
                ...
                "TeachingObject": TeachingObject, "HeadTeacher": HeadTeacher, "TeachingDate": TeachingDate
            },
              function (data) {
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].TeachingObject + "</td>";
                trHTML += "<td style='width:40%;'>" + jsonArr[i].TeachingContent + "</td>";
                trHTML += "<td>" + jsonArr[i].HeadTeacher + "</td>";
            ...
            <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="listTableHeadTR" style="height: 22px;" width="20%">
                        <img height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />学员教学记录查询结果                  
                    </td>
