<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="teachers_StudentsJoinTeachingRecords_View" %>
    ...
    <script type="text/javascript">
        ...
        function loadAllData(id) {
            $.ajax({
                cache: false,
                type: "get",
                url: "../../students/JoinTeachingRecords/ashx/loadAllData.ashx",
                dataType: "text",
                data: { id: id },
                success: function (data) {
                    ...
                    if (json == null) { return; } else {
                        ...
                        $("#Id").val(json.Id);
                        $("#StudentsRealName").val(json.StudentsRealName); $("#RotaryDept option:selected").text(json.DeptName);
                        ...
                        $("#TeachingObject").val(json.TeachingObject);
                        $("#StudentsNum").val(json.StudentsNum);
                        $("#TeachingContent").val(json.TeachingContent);
                        $("#HeadTeacher").val(json.HeadTeacher);
                        $("#TeachingDate").val(json.TeachingDate);
    ...
    <form id="form1">
        <div align="center">
            ...
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                <tr>
                    <td height="24" align="center" colspan="4" class="detailHead">教学记录</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="15%" class="detailTitle" style="height: 25px;">带教对象<span style="color: #ff0000">*</span></td>
                    <td width="35%"class="detailContent" style="height:25px;">
                        <span class="detailContent" style="height: 25px">
                            <input type="text"id="TeachingObject"name="TeachingObject"style="width:150px;" />
                        </span>
                    </td>
                    <td width="15%" class="detailTitle" style="height: 25px;">人数</td>
                    <td width="35%" colspan="3" class="detailContent" style="height:25px;">
                        <span class="detailContent" style="height: 25px">
                            <input type="text"id="StudentsNum"name="StudentsNum"style="width:150px;" />
                        </span>
                    </td>
                </tr>
                <tr>
                    <td width="15%" class="detailTitle" style="height: 25px;">教学内容<span style="color: #ff0000">*</span></td>
                    <td width="70%" class="detailContent" style="height: 25px;" colspan="3">
                        <span class="detailContent" style="height: 25px">
                            <textarea id="TeachingContent" name="TeachingContent" rows=""cols="" style="width: 100%; height:120px;"></textarea>
                        </span>
                    </td>
                ...
                <tr>
                    <td width="15%" class="detailTitle" style="height: 25px;">主管教师</td>
                    <td width="35%" class="detailContent" style="height:25px;">
                        <span class="detailContent" style="height: 25px">
                            <input type="text" id="HeadTeacher" name="HeadTeacher" style="width: 150px;" />
                        </span>
                    </td>
                    <td width="15%" class="detailTitle" style="height: 25px;">日期<span style="color: #ff0000">*</span></td>
                    <td width="35%" class="detailContent" style="height:25px;">
                        <span class="detailContent" style="height: 25px">
                            <input type="text" id="TeachingDate" name="TeachingDate" style="width: 150px;" onclick="WdatePicker({ maxDate: '%y-%M-%d' });"/>
                        </span>
                    </td>
                </tr>
                <tr>
