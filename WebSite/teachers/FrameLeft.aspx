<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrameLeft.aspx.cs" Inherits="teachers_FrameLeft" %>
   ...
   <title>功能列表</title>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //$("#submenu4").hide();
            $("#submenu4 div table tr td").click(function () {
                alert("该模块由管理员进行操作");
            });
        });
    ...
    <form id="form1" runat="server">
        <div style="padding-left: 2px;">
            <table cellspacing="0" cellpadding="0" width="140">
                <tr>
                    <td class="menu_show" id="menuTitle1" onclick="showsubmenu(1,'05')">住院医师</td>
                </tr>
                <tr>
                    <td id="submenu1" class="auto-style2">
                        <div class="sec_menu" style="width: 142px">
                            <table cellspacing="0" cellpadding="0" width="140">
                                ...
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="#">病例上报 </a></td>
                                </tr>
                        ...
                        <div class="sec_menu" style="width: 142px">
                            <table cellspacing="0" cellpadding="0" width="140">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="StudentsBasicInformation/Frame.html" target="MainFrame">学员基本信息</a></td>
                                </tr>
                                 <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="StudentsRotaryInformation/Frame.html" target="MainFrame">学员轮转信息</a></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="OutDeptExamInformation/Frame.html" target="MainFrame">出科考核信息</a></td>
                                </tr>

                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="AppointInformation/Frame.html" target="MainFrame">预约信息</a></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="QuestionnaireInformation/Frame.html" target="MainFrame">问卷反馈信息</a></td>
                                </tr>
                ...
                <tr>
                    <td class="auto-style1" id="menuTitle3" onclick="showsubmenu(3,'05')">专业基地负责人</td>
                </tr>
                <tr>
                    ...
                    <td id="submenu4" class="auto-style2">
                        <div class="sec_menu" style="width: 142px">
                            <table cellspacing="0" cellpadding="0" width="140">
                                ...
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="#">学员基本信息</a></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="#">学员出科考核</a></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="#">预约信息</a></td>
                                </tr>
