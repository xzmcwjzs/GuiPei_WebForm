<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="teachers_StudentsJoinStudyActivities_List" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function loadPageList(pi) {
            $.post("../../ASHX/CommonList/JoinStudyActivitiesList.ashx", {
            ...
            <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="listTableHeadTR" style="height: 22px;" width="20%">
                        <img height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />学员学术活动查询结果                  
                    </td>
