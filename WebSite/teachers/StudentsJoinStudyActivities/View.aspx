<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="teachers_StudentsJoinStudyActivities_View" %>
    ...
    <script type="text/javascript">
        ...
        function loadAllData(id) {
            $.ajax({
                cache: false,
                type: "get",
                url: "../../students/JoinStudyActivities/ashx/loadAllData.ashx",
                dataType: "text",
                data: { id: id },
                success: function (data) {
                    ...
                    if (json == null) { return; } else {
                        //loadTeacher(json.DeptCode, json.TeacherId);$("#RotaryDept option:selected").text(json.DeptName);
            ...
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                ...
                <tr>
                    ...
                    <td width="70%" class="detailContent" style="height: 25px;" colspan="3">
                        <span class="detailContent" style="height: 25px">
                            <textarea id="ActivityContent" name="ActivityContent" rows=""cols="" style="width: 100%; height:110px;"></textarea>
                        </span>
                    </td>
