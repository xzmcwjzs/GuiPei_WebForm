<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="teachers_StudentsOutpatientEmergency_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadPageList(pi) {
            $.post("../../ASHX/CommonList/OutpatientEmergencyList.ashx", {
                ...
                "RecordType": RecordType, "DiseaseName": DiseaseName, "DiseaseNum": DiseaseNum
            },
              function (data) {
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].RecordTypeName + "</td>";
                trHTML += "<td>" + jsonArr[i].DiseaseName + "</td>";
                trHTML += "<td>" + jsonArr[i].DiseaseNum + "</td>";
                ...
                trHTML += "<td><a onclick=\"OpenTopWindow('View.aspx?id=" + jsonArr[i].Id + "',600,350);\" href='#'><img alt='查看详细资料' src='../../images/imgs/icon_show.gif'/></a></td>";
        ...
        <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="listTableHeadTR" style="height: 22px;" width="20%">
                    <img  height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />学员门/急诊诊治记录查询结果                    
                </td>
