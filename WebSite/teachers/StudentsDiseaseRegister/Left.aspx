<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="teachers_StudentsDiseaseRegister_Left" %>
...
<body style="background-color:#F1F3F5;">
    <form id="form1" runat="server" target="frmright" action="List.aspx">
    <div>
