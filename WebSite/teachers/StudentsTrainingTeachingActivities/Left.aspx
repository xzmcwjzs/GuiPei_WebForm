<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="teachers_StudentsTrainingTeachingActivities_Left" %>
...
<body style="background-color:#F1F3F5;">
    ...
    <div>
        <table cellpadding="1" cellspacing="1" class="qryTable">
            ...
            <tr>
                <td>
                    <input type="text" id="ActivityDate" name="ActivityDate" size="25" onclick="WdatePicker({ position: { left: -10, top: 0 }, maxDate: '%y-%M-%d' });"/>                
                </td>
            </tr>
