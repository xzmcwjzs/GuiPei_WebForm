<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="teachers_StudentsJoinResearchRecords_List" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        var ResearchTitle = "<%=ResearchTitle%>";
        var ResearchManager = "<%=ResearchManager%>";
        var JoinRole = "<%=JoinRole%>";
        var ResearchDate = "<%=ResearchDate%>";
        $(function () {
        ...
        function loadPageList(pi) {
            $.post("../../ASHX/CommonList/JoinResearchRecordsList.ashx", {
                ...
                "ResearchTitle": ResearchTitle, "ResearchManager": ResearchManager, "JoinRole": JoinRole, "ResearchDate": ResearchDate
            },
              function (data) {
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].ResearchTitle + "</td>";
                trHTML += "<td>" + jsonArr[i].ResearchManager + "</td>";
                trHTML += "<td>" + jsonArr[i].JoinRole + "</td>";
                ...
                trHTML += "<td><a onclick=\"OpenTopWindow('View.aspx?id=" + jsonArr[i].Id + "&tag=view',600,350);\" href='#'><img alt='查看详细资料' src='../../images/imgs/icon_show.gif'/></a></td>";
            ...
            <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="listTableHeadTR" style="height: 22px;" width="20%">
                        <img height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />学员科研记录查询结果                  
                    </td>
