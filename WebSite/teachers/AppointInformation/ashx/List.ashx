...
public class List : IHttpHandler
{
    ...
    {  //students_name rotary_begin_time rotary_end_time total_score is_pass
        ...
        string appoint_begin_time = context.Request["appoint_begin_time"];
        string appoint_end_time = context.Request["appoint_end_time"];
        ...
        int rowCount = 0;
        int pageCount = 0;
        System.Collections.Generic.List<Model.TeachersAppointInformationModel> list = new BLL.TeachersAppointInformationBLL().GetPageList(training_base_code, dept_code, teachers_name, teachers_real_name,
            appoint_begin_time, appoint_end_time, is_pass,
