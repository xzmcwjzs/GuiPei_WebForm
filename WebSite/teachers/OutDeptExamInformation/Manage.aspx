<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="teachers_OutDeptExamInformation_Manage" %>
        ...
        $(function () {
            ...
            $("#kqqk").blur(function () {
                if ($("#kqqk").val() == "" || !reg.test($("#kqqk").val()) || parseFloat($("#kqqk").val()) > 10) {
                    ...
                    //$("#totalscore").val(parseFloat($("#kqqk").val() == "" ? 0 : $("#kqqk").val()));
                }
