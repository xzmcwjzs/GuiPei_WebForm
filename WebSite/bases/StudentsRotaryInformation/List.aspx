<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="bases_StudentsRotaryInformation_List" %>
...
<script type="text/javascript">
    ...
    //function OutDeptExam(name, tbCode, rdCode, rbTime, reTime, id, pi, tag) {
    //    if (tag == "已申请出科考试") {
    //        var status1 = "出科考核表已提交，请勿重复";
    //        var status2 = "出科考核表尚未提交";
    //        $.post("ashx/OutDeptExam.ashx", { "name": name, "tbCode": tbCode, "rdCode": rdCode, "rbTime": rbTime, "reTime": reTime }, function (data) {
    //            if (data == status1) {
    //                alert("出科考核表已提交，请勿重复");
    //                return;
