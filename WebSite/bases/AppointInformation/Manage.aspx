...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div align="center"><input type="hidden" id="Id" name="Id" />
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                ...
                <tr>
                    ...
                    <td colspan="5" width="20%" class="detailContent" style="height: 25px;">
                        从<input type="text" id="AppointBeginTime" name="AppointBeginTime" style="width:180px" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm' })" />
                ...
                <tr>
                    ...
                    <td colspan="5" width="20%" class="detailContent" style="height: 25px;"><span class="detailContent" style="height: 25px">
                        <textarea id="TrainingContent" name="TrainingContent" style="width:95%;height: 80px"></textarea>
                    </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" width="20%" class="detailContent" style="height: 25px;"><span class="detailContent" style="height: 25px">
                        <textarea id="Comment" name="Comment" rows="3" style="width:95%;height: 80px"></textarea>
                    </span>
                    </td>
                </tr>
                <tr id="fujian">
                     ...
                     <td colspan="6" class="detailContent" style="text-align: right">
                        <table align="right">
                            <tr> 
                                ...
                                <td colspan="5" width="100px" class="detailContent" style="height: 25px;"><span class="detailContent" style="height: 25px">
