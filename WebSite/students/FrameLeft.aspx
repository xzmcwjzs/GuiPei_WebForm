<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrameLeft.aspx.cs" Inherits="students_FrameLeft" %>
    ...
    <form id="form1" runat="server">
        <div style="padding-left: 2px;">
            <table cellspacing="0" cellpadding="0" width="140">
                    ...
                    <td id="submenu1" class="auto-style2">
                        <div class="sec_menu" style="width: 142px">
                            <table cellspacing="0" cellpadding="0" width="140">
                                ...
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="PersonalInformation/Frame.html" target="MainFrame">基本信息 </a></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="RotaryInformation/Frame.html" target="MainFrame">轮转信息</a></td>
                                </tr>
                                
                                 <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="ReportCases/Frame.html" target="MainFrame">病例上报</a></td>
                                </tr>
                            </table>
                        </div>
                    </td>
                        ...
                        <div class="sec_menu" style="width: 142px">
                            <table cellspacing="0" cellpadding="0" width="140">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="#" >学员轮转信息</a></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="#">出科考核信息</a></td>
                                </tr>
                ...
                <tr>
                    <td class="auto-style1" id="menuTitle7" onclick="showsubmenu(7,'05')">统计查询</td>
                </tr>
                <tr>
                    <td id="submenu7" class="auto-style2">
                        <div class="sec_menu" style="width: 142px">
                            <table  cellspacing="0" cellpadding="0" width="140">
                                ...
                                <tr>
                                    <td style="height: 20px;"><span style="color: #84bf92">&middot;</span><a href="BasicInformation/Family/Frame.htm" target="MainFrame">结业考核</a></td>
                                </tr>
                            </table>
                        </div>
                    </td>
