<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="students_PersonalInformation_Manage" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                ...
                function (data) {
                    ...
                    if (dat != "") {
                        for (var i = 0; i < dat.length; i++) {
                            ...
                            if (dat[i].province == $("#province1").val()) {
            ...
            $("#area").change(function () {
                var are = $("#area").find("option:selected").text();
                if (are == "==请选择==") {
                    $("#area1").val("");
    ...
    <script type="text/javascript">
        ...
        function countBirthDate() {
            ...
            if (cardNum.length == 15) {
                ...
                document.getElementById('datebirth').innerText = date;
                document.getElementById('datebirth1').value = date;
            }
            return true;
        }
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                <tr>
                    <td height="24" align="center" colspan="6" class="detailHead">个人信息填写</td>
                </tr>
                <tr>
                    ...
                    <td width="23%" class="detailContent" style="height: 25px">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="23%" class="detailContent" style="height: 25px"><span class="detailContent" style="height: 25px"><span class="detailContent" style="height: 25px">
                        <asp:Label ID="datebirth" runat="server" Width="160px"></asp:Label>
                        <asp:HiddenField ID="datebirth1" runat="server" />
                    </span></span></td>
                    ...
                    <td class="detailContent" style="height: 25px" width="23%"><span class="detailContent" style="height: 25px">
                        ...
                        <asp:HiddenField ID="age1" runat="server" />
                    </span></td>
                    </tr>
                   <tr>
                    ...
                    <td colspan="5" class="detailContent" style="height: 25px" ><span class="detailContent" style="height: 25px">
                        ...
                        <asp:HiddenField ID="province1" runat="server" />
                        <asp:HiddenField ID="city1" runat="server" />
                        <asp:HiddenField ID="area1" runat="server" />
                     </span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="23%" class="detailContent" style="height: 25px"><span class="detailContent" style="height: 25px">
                        ...
                        <asp:DropDownList ID="high_education" runat="server">
                            ...
                            <asp:ListItem Selected="True">硕士研究生</asp:ListItem>
                ...
                <tr>
                    ...
                    <td width="23%" class="detailContent" style="height: 25px" colspan="3"><span class="detailContent" style="height: 25px">
                        <select id="training_base_province" name="training_base_province">
                            <option value="0">==所在省市==</option>
                        </select>
                        <select id="training_base" name="training_base">
                            <option value="0">==请选择==</option>
                        </select>
                ...
                <tr>
                    ...
                    <td width="23%" class="detailContent" style="height: 25px"><span class="detailContent" style="height: 25px">
                       <select id="professional_base" name="professional_base">
                           <option value="0">==请选择==</option>
                    ...
                    <td width="23%" class="detailContent" style="height: 25px"><span class="detailContent" style="height: 25px">
                        <asp:DropDownList ID="plan_training_time" runat="server">
                            <asp:ListItem Value="1年" Text="1年"></asp:ListItem>
                            <asp:ListItem Value="2年" Text="2年"></asp:ListItem>
                            <asp:ListItem Selected="True" Value="3年" Text="3年"></asp:ListItem>
                            <asp:ListItem Value="4年" Text="4年"></asp:ListItem>
                            <asp:ListItem Value="5年" Text="5年"></asp:ListItem>
                            <asp:ListItem Value="6年" Text="6年"></asp:ListItem>
                            <asp:ListItem Value="7年" Text="7年"></asp:ListItem>
                            <asp:ListItem Value="8年" Text="8年"></asp:ListItem>
                            <asp:ListItem Value="9年" Text="9年"></asp:ListItem>
                            <asp:ListItem Value="10年" Text="10年"></asp:ListItem>
