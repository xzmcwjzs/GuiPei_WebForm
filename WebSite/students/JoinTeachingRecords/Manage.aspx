<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="students_JoinTeachingRecords_Manage" %>
                ...
                <tr>
                    ...
                    <td width="70%" class="detailContent"  colspan="3">
                        <span class="detailContent" >
                            <textarea id="TeachingContent" name="TeachingContent" rows=""cols="" style="width: 100%; height:100px;"></textarea>
                        </span>
                    </td>
