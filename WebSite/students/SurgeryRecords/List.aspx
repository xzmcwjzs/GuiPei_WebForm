<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="students_SurgeryRecords_List" %>
    ...
    <script type="text/javascript">
        ...
        function check(teacher_check, id, pi) {
            if (teacher_check == "已通过") {
                ...
                OpenTopWindow("Manage.aspx?id=" + id + "&pi=" + pi + "", 650, 500);
            }
        }
    </script>
        ...
        <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="listTableHeadTR" style="height: 22px;" width="20%">
                    <img  height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />手术记录查询结果                   
                </td>
