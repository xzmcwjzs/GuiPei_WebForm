<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="students_AdviceFeedback_Manage" %>
            ...
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                ...
                <tr>
                    ...
                    <td width="70%" class="detailContent" style="height: 25px;" colspan="3">
                        <span class="detailContent" style="height: 25px">
                            <textarea id="FeedbackInformation" name="FeedbackInformation" rows=""cols="" style="width: 100%; height: 100px;"></textarea>
                        </span>
                    </td>
                ...
                <tr>
                    ...
                    <td width="70%" class="detailContent" style="height: 25px;" colspan="3">
                        <span class="detailContent" style="height: 25px">
                            <textarea id="ManagerReply" name="ManagerReply" rows=""cols="" style="width: 100%; height:100px;" disabled="disabled"></textarea>
                        </span>
                    </td>
                 ...
                 <tr>
                    ...
                    <td width="100%" class="detailContent" style="height: 25px" colspan="5">
                        <table align="right">
                            <tr>
                                <td width="100px" class="detailTitle" style="height: 25px">管理员<span style="color: #ff0000">*</span></td>
                                ...
                                <td width="100px" class="detailTitle" style="height: 25px">日期<span style="color: #ff0000">*</span></td>
                                <td width="100px" class="detailContent" style="height: 25px">
                                    <span class="detailContent" style="height: 25px">
                    ...
                    <td width="100%" class="detailContent" style="height: 25px" colspan="5">
                        <table align="right">
                            <tr>
                                ...
                                <td width="100px" class="detailTitle" style="height: 25px">填写人<span style="color: #ff0000">*</span></td>
                                <td width="100px" class="detailContent" style="height: 25px">
                                    <span class="detailContent" style="height: 25px">
                                        <input type="text" id="Writor" name="Writor" style="width: 100px;"/>
                                    </span>
                                </td>
                                <td width="100px" class="detailTitle" style="height: 25px">登记日期<span style="color: #ff0000">*</span></td>
                                <td width="100px" class="detailContent" style="height: 25px">
                                    <span class="detailContent" style="height: 25px">
