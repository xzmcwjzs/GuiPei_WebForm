<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="students_AdviceFeedback_List" %>
    ...
    <script type="text/javascript">
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td><a onclick=\"check('" + jsonArr[i].ManagerHandle + "','" + jsonArr[i].Id + "','" + pi + "');\" href='#'><img alt='修改该记录' src='../../images/imgs/icon_edit.gif'/></a></td>";
