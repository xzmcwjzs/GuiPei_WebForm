<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="students_AdviceFeedback_Left" %>
...
<body style="background-color:#F1F3F5;">
    ...
    <div>
        <table cellpadding="1" cellspacing="1" class="qryTable">
            ...
            <tr>
                <td>
                    <select id="ManagerHandle" name="ManagerHandle" style="width: 150px;">
