<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="students_News_Manage" ValidateRequest="false"%>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div align="center">
            ...
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                <tr>
                    <td height="24" align="center" colspan="2" class="detailHead">新闻公告
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%" class="detailContent" ><span class="detailContent" >
                     ...
                     <td colspan="2" class="detailContent">
                        <table align="right">
                            <tr> 
                                ...
                                <td width="80px" class="detailTitle" style="height: 25px;">发布时间：<span style="color: #ff0000">*</span></td>
                                <td width="100px" class="detailContent" style="height: 25px;"><span class="detailContent" style="height: 25px">
