<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frame.aspx.cs" Inherits="students_Frame" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #0354de;">
                                        <tr align="right">
                                            ...
                                            <td height="26" align="left" valign="bottom" background="../images/main/top_logo_bg.gif">
                                                ...
                                                <div style="color: red; font-size: 16px; font-weight: bold;"><asp:Literal ID="training_base" runat="server"></asp:Literal><a style="padding-left:2em;">住院医师信息系统工作站</div>
                                            </td>
                                        </tr>
                                        <tr align="right">
