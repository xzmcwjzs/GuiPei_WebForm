<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="students_TrainingTeachingActivities_Manage" %>
                ...
                <tr>
                    <td colspan="4" class="detailContent" style="text-align: center">
                        <table style="margin: 0 auto;text-align: center">
                            <tr>
                                <td class="detailTitle" style="height: 25px;width:100px">主讲人<span style="color: #ff0000">*</span></td>
                                ...
                                <td class="detailTitle" style="height: 25px;width:100px">学时</td>
                                <td class="detailContent" style="height: 25px;width:100px"><span class="detailContent" style="height: 25px">
                                    <asp:TextBox ID="ClassHour" runat="server" Text="" Width="100px"></asp:TextBox></span>
                                </td>
                                <td class="detailTitle" style="height: 25px;width:100px">活动日期<span style="color: #ff0000">*</span></td>
                                <td class="detailContent" style="height: 25px;width:100px"><span class="detailContent" style="height: 25px">
