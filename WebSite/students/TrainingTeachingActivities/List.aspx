<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="students_TrainingTeachingActivities_List" %>
    ...
    <script type="text/javascript">
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].ActivityContent + "</td>";
        ...
        <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="listTableHeadTR" style="height: 22px;" width="20%">
                    <img  height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />培训教学活动查询结果                    
                </td>
