<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Questionnaire.aspx.cs" Inherits="students_RotaryInformation2_Questionnaire" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                ...
                <tr>
                    <td colspan="3" align="center" style="background-color: #f1f3f5;width: 100%">
                        <table>
                            <tr>
                                <td  class="detailTitle" style="height: 25px;">培训基地：<span style="color: #ff0000">*</span></td>
                                <td class="detailContent" style="height: 25px;" align="left">
                                    <asp:Literal ID="training_base_name" runat="server"></asp:Literal>
                                    <asp:HiddenField ID="training_base_code" runat="server" />
                                </td>
                                <td  class="detailTitle" style="height: 25px;">专业基地：<span style="color: #ff0000">*</span></td>
                                <td class="detailContent" style="height: 25px;" align="left">
                                    <asp:Literal ID="professional_base_name" runat="server"> 
                                    </asp:Literal><asp:HiddenField ID="professional_base_code" runat="server" />
                                </td>
                                <td  class="detailTitle" style="height: 25px;">轮转科室：<span style="color: #ff0000">*</span></td>
                                <td class="detailContent" style="height: 25px;" align="left">
                                    <asp:Literal ID="rotary_dept_name" runat="server"></asp:Literal>
                                    <asp:HiddenField ID="rotary_dept_code" runat="server" />
                                </td>
                                <td  class="detailTitle" style="height: 25px;">指导医师：<span style="color: #ff0000">*</span></td>
                                <td class="detailContent" style="height: 25px;" align="left">
                    ...
                    <td align="center" colspan="3">
                        <table width="100%" border="1" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                            ...
                            <tr>
                                ...
                                <td width="15%" style="height: 80px; background-color: #e2ebfb;" align="left">您对我院指导老师及轮转科室的评价、建议和出科小结：</td>
                                <td width="20%" class="detailContent" style="height: 80px;" align="left">
                                    <asp:TextBox ID="advice" runat="server" TextMode="MultiLine" Width="100%" Height="80px"></asp:TextBox>
                                </td>
                            </tr>
                         </table>
                       </td> 
