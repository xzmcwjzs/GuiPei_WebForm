<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="students_RotaryInformation_View" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                <tr>
                    <td height="24" align="center" colspan="6" class="detailHead">个人轮转信息</td>
                </tr>
                 <tr>
