<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="students_PublishArticalRecords_List" %>
    ...
    <script type="text/javascript">
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].PublishDate + "</td>";
        ...
        function check(teacher_check, id, pi) {
            if (teacher_check == "已通过") {
                ...
                OpenTopWindow("Manage.aspx?id=" + id + "&pi=" + pi + "&tag=manage", 600, 400);
            }
        }
    </script>
            ...
            <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="listTableHeadTR" style="height: 22px;" width="20%">
                        <img height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />发表文章记录查询结果                  
                    </td>
