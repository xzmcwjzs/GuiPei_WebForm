<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="students_BigMedicalRecords_Manage" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (json == null) { return; } else {
                        ...
                        if ($("#XZZhenDuan").val() != "") { $("#XZZhenDuan").removeAttr("disabled"); }
                        if ($("#Reviewer").val() != "") { $("#Reviewer").removeAttr("disabled"); }
                        if ($("#ReviewerDate").val() != "") { $("#ReviewerDate").removeAttr("disabled"); }
                    }
                },
                error: function () {
                    alert("系统繁忙，请联系管理员");
        ...
        <div align="center">
            ...
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                ...
                <tr>
                    ...
                    <td width="10%" class="detailContent" colspan="9">
                ...
                <tr>
                    ...
                    <td width="10%" class="detailContent" colspan="8">
                        <span class="detailContent" >
               ...
               <%-- <tr><td height="0" colspan="10"><hr style="width:100%;color:#000;" size="1" /></td></tr>--%>
                ...
                <tr>
                    ...
                    <td width="10%" class="detailContent"  colspan="3">
                        <span class="detailContent" >
                    ...
                    <td width="10%" class="detailContent"  colspan="4">
                        <span class="detailContent" >
                ...
                <tr>
                    <td colspan="8" style="text-align:center;width:100%;"class="detailContent">
                        <table style="border:1px solid #000;border-collapse:collapse;margin:0 auto">
                            <tr>
                ...
                <tr>
                    <td width="10%" class="detailContent"  colspan="10">
                        <span class="detailContent" >
