<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Statics_Managers_CollaborativeUnit_List" %>
...
<body style="text-align:center;" >
    ...
    <div style="margin:0 auto;padding-top:10px; height: 220px;width:98%">
            <table class="table table-bordered" id="StaticsTable">
                <caption><b style="font:800 18px '宋体'">学员协同单位表格统计</b></caption>
                 
                    <tr>
                        <th id="StaticsD">协同单位</th>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsonArr, function (i, val) {
                        label[i] = val["CollaborativeUnit"];
                        value[i] = { 'name': val["CollaborativeUnit"], 'value': val['CountCU'] };
                        total += val['CountCU'];
                    });
