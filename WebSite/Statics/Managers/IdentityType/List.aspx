<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Statics_Managers_IdentityType_List" %>
...
<body style="text-align:center;" >
    ...
    <div style="margin:0 auto;padding-top:10px; height: 220px;width:60%">
            <table class="table table-bordered" id="StaticsTable">
                <caption><b style="font:800 18px '宋体'">学员身份类型表格统计</b></caption>
                 
                    <tr>
                        <th id="StaticsD">身份类型</th>
    ...
    <div id="main" style="width: 60%; max-width: 110%; height: 400px;margin:0 auto;padding-top: 10px"></div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsonArr, function (i, val) {
                        label[i] = val["IdentityType"];
                        value[i] = { 'name': val["IdentityType"], 'value': val['CountIT'] };
                        total += val['CountIT'];
                    });
