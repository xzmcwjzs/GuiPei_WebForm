<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Statics_Managers_TrainingTime_List" %>
...
<body style="text-align:center;" >
    ...
    <div style="margin:0 auto;padding-top:10px; height: 220px;width:90%">
            <table class="table table-bordered" id="StaticsTable">
                <caption><b style="font:800 18px '宋体'">学员参训时间表格统计</b></caption>
                 
                    <tr>
                        <th id="StaticsD">参训时间</th>
    ...
    <div id="main" style="width: 80%; max-width: 110%; height: 400px;margin:0 auto;padding-top: 10px"></div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsonArr, function (i, val) {
                        label[i] = val["TrainingTime"];
                        value[i] = { 'name': val["TrainingTime"], 'value': val['CountTT'] };
                        total += val['CountTT'];
                    });
