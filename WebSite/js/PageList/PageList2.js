...
function createPageBar(pagelistdiv, pageindex, recordcount, pagecount) {
    ...
    var divHtml = "共" + recordcount + "条<a style='padding-left:1em;'></a>分" + pagecount + "页<a style='padding-left:1em;'></a>" +
        "第" + pageindex + "页<a style='padding-left:1em;'></a>跳转到<input type='Text' id='index' name='index' style='width:22px;height:20px;padding:0px;'/>" +
        "<input type='Button' id='go' value='GO' style='width:22px;height:20px;font-size:10pt;text-align:left;padding:0px;'  onclick='Go(" + pagecount + ")'/><a style='padding-left:1em;'></a>" +
