<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="managers_StudentsRescuePatientRecords_List" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadPageList(pi) {
            $.post("../../ASHX/CommonList/RescuePatientRecordsList.ashx", {
                ...
                "PatientName": PatientName, "CaseId": CaseId, "DiseaseName": DiseaseName, "Condition": Condition,
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].DiseaseName + "</td>";
                trHTML += "<td style='width:20%;'>" + jsonArr[i].RescueMeasure + "</td>";
                trHTML += "<td>" + jsonArr[i].Condition + "</td>";
                trHTML += "<td style='color:red;'>" + jsonArr[i].TeacherCheck + "</td>";
                trHTML += "<td><a onclick=\"OpenTopWindow('View.aspx?id=" + jsonArr[i].Id + "',600,440);\" href='#'><img alt='查看详细资料' src='../../images/imgs/icon_show.gif'/></a></td>";
        ...
        <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td class="listTableHeadTR" style="height: 22px;" width="20%">
                    <img  height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />学员抢救病人记录查询结果                    
                </td>
