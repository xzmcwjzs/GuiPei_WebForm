<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="managers_StudentsRotaryInformation_Left" %>
    ...
    <div>
        <table cellpadding="1" cellspacing="1" class="qryTable">
           <tr>
            ...
            <tr>
                <td>计划参训年限：<span style="color: #ff0000">(例:3年)</span></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>出科状态：<asp:DropDownList ID="OutDeptStatus" runat="server">
