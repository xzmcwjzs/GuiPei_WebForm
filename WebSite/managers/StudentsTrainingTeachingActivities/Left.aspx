<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="managers_StudentsTrainingTeachingActivities_Left" %>
...
<body style="background-color:#F1F3F5;">
    ...
    <div>
        <table cellpadding="1" cellspacing="1" class="qryTable">
            ...
            <tr>
                <td>
                    <input type="text" id="ActivityDate" name="Condition" size="25" />                
                </td>
            </tr>
