<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frame.aspx.cs" Inherits="managers_Frame" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #0354de;">
                                        <tr align="right">
                                            ...
                                            <td height="26" align="left" valign="bottom" background="../images/main/top_logo_bg.gif">
                                                ...
                                                <div style="color: red; font-size: 16px; font-weight: bold;">管理员信息系统工作站</div>
                                            </td>
                                        </tr>
                                        <tr align="right">
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="white" style="background-color: #0066cc;">
                                        ...
                                        <asp:Literal ID="ltRealName" runat="server"></asp:Literal>
                                                <a style="color: White;" href="javascript:OpenTopWindow('ModifyPassword.aspx?username=<%=managersModel.managers_name%>',500,200);">(修改密码)</a>
                                                &nbsp;日期：
