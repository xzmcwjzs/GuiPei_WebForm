<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="managers_StudentsSkillRequirement_View" %>
        ...
        <div align="center">
            ...
            <table width="100%" border="0" style="border-collapse: collapse" cellpadding="0" cellspacing="1" class="detailTable">
                ...
                <tr>
                    ...
                    <td colspan="3" width="70%" class="detailContent" style="height:25px;"><span class="detailContent" style="height: 25px">
                        <textarea rows="" cols="" id="Comment" name="Comment" style="width:100%;height:110px;"></textarea>
                        </span>
                    </td>
                 </tr>
                <tr id="last">
