...
public partial class managers_QuestionnaireInformation_List : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RunQuestionnaireChart("QuestionnaireChartManagers", out sum, out one_a, out  one_b, out  one_c, out  one_d, out  one_e,
              ...
              out  thirteen_a, out  thirteen_b, out  thirteen_c, out  thirteen_d, out  thirteen_e, TrainingBaseCode);
    ...
    public static void RunQuestionnaireChart(string proName, out int sum, out int one_a, out int one_b, out int one_c, out int one_d, out int one_e,
        ...
        out int thirteen_a, out int thirteen_b, out int thirteen_c, out int thirteen_d, out int thirteen_e, string training_base_code)
    {
