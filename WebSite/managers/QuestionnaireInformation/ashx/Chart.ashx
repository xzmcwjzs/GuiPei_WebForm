...
public class Chart : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        int sum = 0;
        int one_a = 0; int one_b = 0; int one_c = 0; int one_d = 0; int one_e = 0;
        int two_a = 0; int two_b = 0; int two_c = 0; int two_d = 0; int two_e = 0;
        int three_a = 0; int three_b = 0; int three_c = 0; int three_d = 0; int three_e = 0;
        int four_a = 0; int four_b = 0; int four_c = 0; int four_d = 0; int four_e = 0;
        int five_a = 0; int five_b = 0; int five_c = 0; int five_d = 0; int five_e = 0;
        int six_a = 0; int six_b = 0; int six_c = 0; int six_d = 0; int six_e = 0;
        int seven_a = 0; int seven_b = 0; int seven_c = 0; int seven_d = 0; int seven_e = 0;
        int eight_a = 0; int eight_b = 0; int eight_c = 0; int eight_d = 0; int eight_e = 0;
        int nine_a = 0; int nine_b = 0; int nine_c = 0; int nine_d = 0; int nine_e = 0;
        int ten_a = 0; int ten_b = 0; int ten_c = 0; int ten_d = 0; int ten_e = 0;
        int eleven_a = 0; int eleven_b = 0; int eleven_c = 0; int eleven_d = 0; int eleven_e = 0;
        int twelve_a = 0; int twelve_b = 0; int twelve_c = 0; int twelve_d = 0; int twelve_e = 0;
        int thirteen_a = 0; int thirteen_b = 0; int thirteen_c = 0; int thirteen_d = 0; int thirteen_e = 0;
  ...
  out  thirteen_a, out  thirteen_b, out  thirteen_c, out  thirteen_d, out  thirteen_e);
    ...
    public static void RunQuestionnaireChart(string proName,out int sum,out int one_a,out int one_b,out int one_c,out int one_d,out int one_e,
        ...
        out int thirteen_a, out int thirteen_b, out int thirteen_c, out int thirteen_d, out int thirteen_e)
