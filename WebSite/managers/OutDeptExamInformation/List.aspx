<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="managers_OutDeptExamInformation_List" %>
...
<script type="text/javascript">
    ...
    function loadPageList(pi) {
        ...
        $.post("../../ASHX/CommonList/OutDeptExamList.ashx", {
            "pi": pi, "TrainingBaseCode": TrainingBaseCode, "ProfessionalBaseCode": ProfessionalBaseCode,
            "StudentsRealName": StudentsRealName, "DeptName": DeptName, "TeachersRealName": TeachersRealName,
            "RotaryBeginTime": RotaryBeginTime, "RotaryEndTime": RotaryEndTime, "TotalScore": TotalScore, "IsPass": IsPass,
