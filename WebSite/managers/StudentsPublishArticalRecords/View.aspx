<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="managers_StudentsPublishArticalRecords_View" %>
    ...
    <script type="text/javascript">
        ...
        function loadAllData(id) {
            $.ajax({
                cache: false,
                type: "get",
                url: "../../students/PublishArticalRecords/ashx/loadAllData.ashx",
                dataType: "text",
                data: { id: id },
