<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="managers_StudentsMedicalError_List" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function loadPageList(pi) {
            $.post("../../ASHX/CommonList/MedicalErrorList.ashx", {
                ...
                "ErrorCategory": ErrorCategory, "ErrorDate": ErrorDate,
        ...
        function createRows(jsonArr, pi) {
            ...
            for (i = 0; i < jsonArr.length; i++) {
                ...
                trHTML += "<td>" + jsonArr[i].ErrorCategory + "</td>";
                trHTML += "<td style='width:40%;'>" + jsonArr[i].ErrorDetail + "</td>";
                trHTML += "<td>" + jsonArr[i].ErrorDate + "</td>";
            ...
            <table class="listTableHead" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="listTableHeadTR" style="height: 22px;" width="20%">
                        <img height="16" src="../../images/imgs/Query.gif" width="16" style="vertical-align: middle" />学员医疗差错事故查询结果                  
                    </td>
