...
namespace DAL
{
   public  class JoinTeachingRecordsDAL
    {
       SqlHelper db = new SqlHelper();
       #region Add(JoinTeachingRecordsModel model)
       public bool Add(JoinTeachingRecordsModel model)
       {
           StringBuilder strSql = new StringBuilder();
           strSql.Append("insert into GP_JoinTeachingRecords(");
           strSql.Append("Id,StudentsRealName,StudentsName,TrainingBaseCode,TrainingBaseName,ProfessionalBaseCode,ProfessionalBaseName,DeptCode,DeptName,RegisterDate,Writor,TeacherCheck,KzrCheck,BaseCheck,ManagerCheck,TeacherId,TeacherName,Comment,TeachingObject,StudentsNum,TeachingContent,HeadTeacher,TeachingDate)");
           ...
           SqlParameter[] parameters = {
					...
					new SqlParameter("@TeachingObject", SqlDbType.NVarChar,50),
					new SqlParameter("@StudentsNum", SqlDbType.NVarChar,50),
					new SqlParameter("@TeachingContent", SqlDbType.NVarChar,2000),
					new SqlParameter("@HeadTeacher", SqlDbType.NVarChar,50),
					new SqlParameter("@TeachingDate", SqlDbType.NVarChar,50)};
           ...
           parameters[18].Value = model.TeachingObject;
           parameters[19].Value = model.StudentsNum;
           parameters[20].Value = model.TeachingContent;
           parameters[21].Value = model.HeadTeacher;
           parameters[22].Value = model.TeachingDate;
       ...
       public bool Delete(string Id)
       {
           ...
           StringBuilder strSql = new StringBuilder();
           strSql.Append("delete from GP_JoinTeachingRecords ");
       ...
       {
           StringBuilder strSql = new StringBuilder();
           strSql.Append("select  top 1 Id,StudentsRealName,StudentsName,TrainingBaseCode,TrainingBaseName,ProfessionalBaseCode,ProfessionalBaseName,DeptCode,DeptName,RegisterDate,Writor,TeacherCheck,KzrCheck,BaseCheck,ManagerCheck,TeacherId,TeacherName,Comment,TeachingObject,StudentsNum,TeachingContent,HeadTeacher,TeachingDate from GP_JoinTeachingRecords ");
           strSql.Append(" where Id=@Id ");
           SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.NVarChar,50)			};
           parameters[0].Value = Id;
           ...
           List<JoinTeachingRecordsModel> list = null;
           if (dt.Rows.Count > 0)
           {
               list = new List<JoinTeachingRecordsModel>();
               JoinTeachingRecordsModel model = null;
               foreach (DataRow row in dt.Rows)
               {
                   model = new JoinTeachingRecordsModel();
       ...
       #region Update(JoinTeachingRecordsModel model)
       public bool Update(JoinTeachingRecordsModel model)
       {
           StringBuilder strSql = new StringBuilder();
           strSql.Append("update GP_JoinTeachingRecords set ");
           ...
           strSql.Append("TeachingObject=@TeachingObject,");
           strSql.Append("StudentsNum=@StudentsNum,");
           strSql.Append("TeachingContent=@TeachingContent,");
           strSql.Append("HeadTeacher=@HeadTeacher,");
           strSql.Append("TeachingDate=@TeachingDate");
           strSql.Append(" where Id=@Id ");
           SqlParameter[] parameters = {
					new SqlParameter("@StudentsRealName", SqlDbType.NVarChar,50),
					new SqlParameter("@StudentsName", SqlDbType.NVarChar,50),
           ...
           parameters[13].Value = model.TeachingObject;
           parameters[14].Value = model.StudentsNum;
           parameters[15].Value = model.TeachingContent;
           parameters[16].Value = model.HeadTeacher;
           parameters[17].Value = model.TeachingDate;
     ...
     #region DataRowToModel(DataRow row)
       public JoinTeachingRecordsModel DataRowToModel(DataRow row)
       {
           JoinTeachingRecordsModel model = new JoinTeachingRecordsModel();
           if (row != null)
           {
               if (row["Id"] != null)
               {
               ...
               if (row["TeachingObject"] != null)
               {
                   model.TeachingObject = row["TeachingObject"].ToString();
               }
               if (row["StudentsNum"] != null)
               {
                   model.StudentsNum = row["StudentsNum"].ToString();
               }
               if (row["TeachingContent"] != null)
               {
                   model.TeachingContent = row["TeachingContent"].ToString();
               }
               if (row["HeadTeacher"] != null)
               {
                   model.HeadTeacher = row["HeadTeacher"].ToString();
               }
               if (row["TeachingDate"] != null)
               {
                   model.TeachingDate = row["TeachingDate"].ToString();
               }
           }
           return model;
       } 
       ...
       int start, int end)
       {
           string sql = "select * from (select row_number() over(order by RegisterDate desc) as num,* from GP_JoinTeachingRecords where StudentsName='" + StudentsName + "' and TrainingBaseCode='" + TrainingBaseCode + "'";

           if (!string.IsNullOrEmpty(DeptName))
           {
               sql += "and DeptName like '%" + DeptName + "%'";
           }
           if (!string.IsNullOrEmpty(TeachingObject))
           {
               sql += "and TeachingObject like '%" + TeachingObject + "%'";
           }
           if (!string.IsNullOrEmpty(HeadTeacher))
           {
               sql += "and HeadTeacher like '%" + HeadTeacher + "%'";
           }
           if (!string.IsNullOrEmpty(TeachingDate))
           {
               sql += "and TeachingDate like '%" + TeachingDate + "%'";
           }
       ...
       public int GetRecordCount(string StudentsName, string TrainingBaseCode, string DeptName,
           string TeachingObject, string HeadTeacher, string TeachingDate)
       {
           string sql = "select count(*) from GP_JoinTeachingRecords where TrainingBaseCode='" + TrainingBaseCode
       ...
       int start, int end)
       {
           string sql = "select * from (select row_number() over(order by RegisterDate desc) as num,* from GP_JoinTeachingRecords where  TrainingBaseCode like '%" + TrainingBaseCode + "%'";
       ...
       public int CommonGetRecordCount(string StudentsRealName, string TrainingBaseCode, string ProfessionalBaseCode, string DeptCode, string TeachersName, string ProfessionalBaseName, string DeptName, string TeachersRealName,
           string TeachingObject, string HeadTeacher, string TeachingDate)
       {
           string sql = "select count(*) from GP_JoinTeachingRecords where TrainingBaseCode like '%" + TrainingBaseCode + "%'";
           if (!string.IsNullOrEmpty(StudentsRealName))
           {
               sql += "and StudentsRealName like '%" + StudentsRealName + "%'";
           }
